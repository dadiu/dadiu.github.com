...
// 本地预览
gulp.task('default', ['buildClean', 'buildAppJS', 'buildCss', 'buildImg', 'copyFile', 'copyMusic', 'browser-sync'], function() {

    gulp.watch(basePath + 'scss/*.scss', ['buildCss']);
    gulp.watch(basePath + 'js/*.js', ['buildAppJS']);
...
// 发布
gulp.task('publish', ['buildClean', 'buildAppJS', 'buildCss', 'buildImg', 'copyMusic', 'copyFile'], function() {
