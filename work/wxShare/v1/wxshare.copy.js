var mainObj = {
    ajaxPath: document.location.protocol + '//m3guowechat.dataitf.17m3.com',
...
(function($) {
    ...
    var wxapi = mainObj.ajaxPath + '/weixin_share/jweixin-1.2.0.js',
    ...
    var wxManage = {
        ...
        getTicket: function(callback) {
            ...
            $.ajax({
                ...
                url: mainObj.ajaxPath + '/wechat/get_dianhun_ticket/',
                type: 'get',
                crossDomain: true,
                dataType: 'jsonp',
                jsonp: "callback",
