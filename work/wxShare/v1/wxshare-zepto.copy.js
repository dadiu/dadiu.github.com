var mainObj = {
    ajaxPath: '//m3guowechat.dataitf.17m3.com',
...
Zepto(function($) {
    ...
    function core_sha1(a, b) { a[b >> 5] |= 128 << 24 - b % 32, a[(b + 64 >> 9 << 4) + 15] = b; for (var c = Array(80), d = 1732584193, e = -271733879, f = -1732584194, g = 271733878, h = -1009589776, i = 0; i < a.length; i += 16) { for (var j = d, k = e, l = f, m = g, n = h, o = 0; 80 > o; o++) { 16 > o ? c[o] = a[i + o] : c[o] = rol(c[o - 3] ^ c[o - 8] ^ c[o - 14] ^ c[o - 16], 1); var p = safe_add(safe_add(rol(d, 5), sha1_ft(o, e, f, g)), safe_add(safe_add(h, c[o]), sha1_kt(o)));
            ...
            d = safe_add(d, j), e = safe_add(e, k), f = safe_add(f, l), g = safe_add(g, m), h = safe_add(h, n) } return Array(d, e, f, g, h) }
    ...
    function core_hmac_sha1(a, b) { var c = str2binb(a);
        c.length > 16 && (c = core_sha1(c, a.length * chrsz)); for (var d = Array(16), e = Array(16), f = 0; 16 > f; f++) d[f] = 909522486 ^ c[f], e[f] = 1549556828 ^ c[f]; var g = core_sha1(d.concat(str2binb(b)), 512 + b.length * chrsz); return core_sha1(e.concat(g), 672) }

    function safe_add(a, b) { var c = (65535 & a) + (65535 & b),
    ...
    function binb2b64(a) { for (var b = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", c = "", d = 0; d < 4 * a.length; d += 3)
            for (var e = (a[d >> 2] >> 8 * (3 - d % 4) & 255) << 16 | (a[d + 1 >> 2] >> 8 * (3 - (d + 1) % 4) & 255) << 8 | a[d + 2 >> 2] >> 8 * (3 - (d + 2) % 4) & 255, f = 0; 4 > f; f++) c += 8 * d + 6 * f > 32 * a.length ? b64pad : b.charAt(e >> 6 * (3 - f) & 63); return c }
    var hexcase = 0,
        b64pad = "",
        chrsz = 8,
        Signature = function() { this._jsapi_ticket = null, this._nonceStr = null, this._timeStamp = null, this._url = null, this._signature = null };
    Signature.prototype.genSign = function(a, b) { this._url = b; var c = { jsapi_ticket: a, nonceStr: this.createNonceStr(), timestamp: this.createTimeStamp(), url: b },
            d = this.raw(c);
        this._signature = hex_sha1(d) }, Signature.prototype.createNonceStr = function() { return this._nonceStr = Math.random().toString(36).substr(2, 15), this._nonceStr }, Signature.prototype.createTimeStamp = function() { return this._timeStamp = parseInt((new Date).getTime() / 1e3) + "", this._timeStamp }, Signature.prototype.raw = function(a) { var b = Object.keys(a);
        b = b.sort(); var c = {};
        b.forEach(function(b) { c[b.toLowerCase()] = a[b] }); var d = ""; for (var e in c) d += "&" + e + "=" + c[e]; return d = d.substr(1) };
